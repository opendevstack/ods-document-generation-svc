package org.ods.shared.lib.openshift
...
class OpenShiftResourceMetadata {
     ...
     *
     * <code>context</code> usually implements either <code>org.ods.shared.lib.component.IContext</code>
     * or <code>org.ods.shared.lib.quickstarter.IContext</code>.
    ...
    OpenShiftResourceMetadata(
        ...
        this.config = config
        this.logger = logger
        this.openShift = openShift ?: new OpenShiftService(steps)
    }
