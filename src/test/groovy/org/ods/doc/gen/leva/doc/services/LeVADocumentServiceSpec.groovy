...
@Slf4j
class LeVADocumentServiceSpec extends Specification {
    ...
    def setup() {
        ...
        usecase = Spy(new LeVADocumentService(project, steps, util, docGen, jenkins, jiraUseCase, junit, levaFiles, nexus, os, pdf, sq, bbt, logger))
    ...
    def "compute test discrepancies"() {
        ...
        usecase = Spy(new LeVADocumentService(project, steps, util, docGen, jenkins, jiraUseCase, junit, levaFiles, nexus, pdf, sq, bbt))
    ...
    def "get correct templates for GAMP category sensitive documents"() {
        ...
        LeVADocumentService.DocumentType.CSD as String  || (LeVADocumentService.DocumentType.CSD as String) + "-999"
        LeVADocumentService.DocumentType.SSDS as String || (LeVADocumentService.DocumentType.SSDS as String) + "-999"
        LeVADocumentService.DocumentType.CFTP as String || (LeVADocumentService.DocumentType.CFTP as String) + "-999"
        LeVADocumentService.DocumentType.CFTR as String || (LeVADocumentService.DocumentType.CFTR as String) + "-999"
        LeVADocumentService.DocumentType.RA as String   || (LeVADocumentService.DocumentType.RA as String)
    }
    ...
    def "create CSD"() {
        ...
        def documentType = LeVADocumentService.DocumentType.CSD as String
        ...
        1 * usecase.getDocumentMetadata(LeVADocumentService.DOCUMENT_TYPE_NAMES[documentType])
    ...
    def "create TRC"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.TRC as String
        ...
        1 * usecase.getWatermarkText(documentType, _) >> watermarkText
        1 * usecase.getDocumentMetadata(LeVADocumentService.DOCUMENT_TYPE_NAMES[documentType], _)
        1 * usecase.createDocument(documentType, null, _, [:], _, documentTemplate, watermarkText) >> uri
        1 * usecase.getSectionsNotDone(documentType) >> []
        1 * usecase.updateJiraDocumentationTrackingIssue(documentType, uri, "${docHistory.getVersion()}")
    }
    ...
    def "create DIL"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.DIL as String
        def uri = "http://nexus"
        def documentTemplate = "template"
        def watermarkText = "WATERMARK"
    ...
    def "create DTP"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.DTP as String
        ...
        1 * usecase.getDocumentMetadata(LeVADocumentService.DOCUMENT_TYPE_NAMES[documentType], repo)
        1 * usecase.createDocument(documentType, null, _, [:], _, documentTemplate, watermarkText) >> uri
        1 * usecase.getSectionsNotDone(documentType) >> []
        1 * usecase.updateJiraDocumentationTrackingIssue(documentType, uri, "${docHistory.getVersion()}")
    }
    ...
    def "create DTR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.DTR as String
    ...
    def "create CFTP"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.CFTP as String
    ...
    def "create CFTR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.CFTR as String
        def files = [ "raw/${xmlFile.name}": xmlFile.bytes ]
    ...
    def "create TCP"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.TCP as String
    ...
    def "create TCR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.TCR as String
        def files = ["raw/${xmlFile.name}": xmlFile.bytes]
    ...
    def "create IVP"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.IVP as String
    ...
    def "create IVR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.IVR as String
        def files = ["raw/${xmlFile.name}": xmlFile.bytes]
    ...
    def "create SSDS #scenario"() {
        ...
        def version = (odsRepoType == PipelineConfig.REPO_TYPE_ODS_CODE) ? 'WIP' : '1.0'
        ...
        FileUtils.copyDirectory(new FixtureHelper().getResource("Test-1.pdf").parentFile, tempFolder);
        def pdfDoc = new FixtureHelper().getResource("Test-1.pdf").bytes

        def documentType = LeVADocumentService.DocumentType.SSDS as String
        ...
        componentTypeLong = LeVADocumentService.INTERNAL_TO_EXT_COMPONENT_TYPES.get(odsRepoType)
        doInstall = !LeVADocumentService.COMPONENT_TYPE_IS_NOT_INSTALLED.contains(odsRepoType)
    ...
    def "create RA"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.RA as String
        ...
        then:
        3 * project.getRisks()
        1 * usecase.getDocumentMetadata(LeVADocumentService.DOCUMENT_TYPE_NAMES[documentType], null)
        1 * usecase.getDocumentTemplateName(documentType) >> documentTemplate
        1 * usecase.createDocument(documentType, null, _, [:], _, documentTemplate, watermarkText) >> uri
        1 * usecase.getSectionsNotDone(documentType) >> []
        1 * usecase.updateJiraDocumentationTrackingIssue(documentType, uri, "${docHistory.getVersion()}")
    ...
    def "create TIP"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.TIP as String
    ...
    def "create TIR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.TIR as String
    ...
    def "create overall DTR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.DTR as String
        def documentTypeName = LeVADocumentService.DocumentType.OVERALL_DTR as String
        ...
        1 * usecase.getDocumentMetadata(LeVADocumentService.DOCUMENT_TYPE_NAMES[documentTypeName])
    ...
    def "create overall TIR"() {
        ...
        // Argument Constraints
        def documentType = LeVADocumentService.DocumentType.TIR as String
        def documentTypeName = LeVADocumentService.DocumentType.OVERALL_TIR as String
    ...
    def "update Jira documentation tracking issue with 2 chapters issue not DONE yet"() {
        ...
        then:
        1 * jiraUseCase.jira.appendCommentToIssue("TRK-1", "A new ${LeVADocumentService.DOCUMENT_TYPE_NAMES[documentType]} has been generated and is available at: ${uri}. Attention: this document is work in progress! See issues: DOC-1, DOC-3")

        then:
        1 * jiraUseCase.jira.appendCommentToIssue("TRK-2", "A new ${LeVADocumentService.DOCUMENT_TYPE_NAMES[documentType]} has been generated and is available at: ${uri}. Attention: this document is work in progress! See issues: DOC-1, DOC-3")
    }
    ...
    def "order steps"() {
        ...
        def  testIssue = [ key: "JIRA-1" ,
            ...
            when:
            LeVADocumentService leVADocumentUseCase = new LeVADocumentService(null, null, null,
    ...
    def "referenced documents version"() {
        ...
        def useCase = Spy(new LeVADocumentService(project, null, null, null, null, jiraUseCase, null, null, null, null, null, null, null, null))
    ...
    def "get version if versioning not enabled"() {
        ...
        def jiraService = Stub(JiraService)
        def jiraUseCase = Spy(new JiraUseCase(null, null, null, jiraService, null))
        def useCase = Spy(new LeVADocumentService(project, steps, null, null, null, jiraUseCase, null, null, null, null, null, null, null, null))
