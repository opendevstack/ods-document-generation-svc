...
class DocumentHistorySpec extends SpecHelper {
    ...
    def "builds docHistory for first project version"() {
        ...
        DocumentHistory history = Spy(constructorArgs: [targetEnvironment, 'LevaDocType'])
    ...
    def "issue type docs is shown as documentation chapter in the history and includes heading number and summary"() {
        ...
        def base_saved_data = [
            ...
            discontinuationsPerType : [(JiraDataItem.TYPE_DOCS): [[key: "discontinued", versions: ['1'], number: 'discontinuedNum', heading: 'heading', documents: ['doc1']]]]
        ]


        DocumentHistory history = Spy(constructorArgs: [targetEnvironment, 'doc1'])
    ...
    def "handle filtered issues that might have no longer be in the document"() {
        ...
        history.data.first()[JiraDataItem.TYPE_DOCS] == result[JiraDataItem.TYPE_DOCS]
    }
